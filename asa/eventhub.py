...
async def run():
    ...
    producer = EventHubProducerClient.from_connection_string(conn_str="Endpoint=sb://asa11081999.servicebus.windows.net/;SharedAccessKeyName=newpolicy;SharedAccessKey=LeHRAvzckAcGpr3KCpKwpwEThMC40OJhHEINL5zR5EA=", eventhub_name="renuhub")
